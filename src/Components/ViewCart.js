                  ...
                  <div className="card card-body cart-table p-2">
                     <div className="table-responsive">
                        <table className="table cart-table">
                           ...
                           <tbody>
                              <tr style={{borderColor:"#e6dddd"}}>
                                 <td className="cart_product"><a href="#"><img className="img-fluid" src="img/item/11.jpg" alt="" /></a></td>
                                 ...
                                 <td className="availability in-stock"><span className="badge bg-success">In stock</span></td>
                                 ...
                                 <td className="price"><span>₹49.88</span></td>
                                 <td className="action">
                                    <a className="btn btn-sm btn-danger" data-bs-original-title="Remove" href="#" title="" data-bs-placement="top" data-bs-toggle="tooltip"><SlClose className="mdi mdi-close-circle-outline" /></a>
                                 </td>
                              </tr>
                              <tr style={{borderColor:"#e6dddd"}}>
                                 <td className="cart_product"><a href="#"><img alt="Product" src="img/item/10.jpg" className="img-fluid" /></a></td>
                                 <td className="cart_description">
                                    <h5 className="product-name"><a href="#">Ipsums Dolors Untra </a></h5>
                                    <h6><strong><span className="mdi mdi-approval"></span> Available in</strong> - 500 gm</h6>
                                 </td>
                                 <td className="availability out-of-stock"><span className="badge bg-primary">No stock</span></td>
                           ...
                           <tfoot style={{borderColor:"#e6dddd"}}>
                              ...
                              <tr>
                                 <td colspan="2"></td>
                                 <td style={{textAlign:"right"}}  colspan="3">Total products (tax incl.)</td>
                                 <td colspan="2">₹10.88 </td>
                              </tr>
                              <tr>
                                 <td style={{textAlign:"right"}} colspan="5"><strong>Total</strong></td>
                                 <td className="text-danger" colspan="2"><strong>₹57.88 </strong></td>
                              </tr>
                           </tfoot>
                        </table>
                     </div>
                     <Link to="/checkout"><button className="btn btn-secondary btn-lg btn-block text-left w-100" type="button"><span style={{float:"left"}}><MdOutlineShoppingCart className="mdi mdi-cart-outline mb-1"/> Proceed to Checkout </span><span style={{float:"right"}}><strong>₹57.88</strong> <span className="mdi mdi-chevron-right"></span></span></button></Link>
                  </div>
