                    ...
                    {isAuthenticated ? (
                        ...
                        <>
                            <div className="product-header">
                             ...
                             <AiOutlineHeart style={{ fontSize: "26px", cursor: "pointer" }} className={`heart-icon ${isLiked ? 'liked' : ''}`} onClick={handleAddToWishlist} data-bs-toggle="tooltip" data-bs-placement="top" title="Add to wishlist" />
                            ...
                            <div className="product-body">
                                ...
                                <h6 className='d-flex'>
                                    ...
                                    </strong>{" "} - <span>{proditem && proditem.items && proditem.items.length > 1 ?
                                        <div className="dropdown">
                                            <select style={{ border: "0px" }} onChange={handleSelectChange}>
                                                {Array.isArray(proditem.items) &&
                                                    proditem.items.map((item) => (

                                                        <option key={item.id} value={JSON.stringify(item)}>{item.unit}</option>
                                                    ))
                                                }
                            ...
                            <div className="product-footer d-flex">
                                {selectedItem !== null && (
                                    <p className="offer-price mb-0">
                                        ₹ {selectedItem.sale_price} <TbTags style={{ fontSize: "16px" }} />
                                        <br />
                                        <span className="regular-price">₹ {selectedItem.mrp_price}</span>
                                    </p>
                                )}
