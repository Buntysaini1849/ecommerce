...
import {MdOutlineRefresh, MdOutlineShoppingBag,MdOutlineShoppingBasket} from "react-icons/md";
import {BsTruck,BsTag} from "react-icons/bs";
import {GiEarthAsiaOceania} from "react-icons/gi";
import { ABOUT_CONTACT_API } from './apiUrls';
import aboutpic from "../Images/about_us_pic.jpg";
         ...
         <div className="container">
            <div className="row">
               <div className="pl-4 col-lg-5 col-md-5 pr-4">
                  <img className="rounded img-fluid" src={aboutpic} alt="Card image cap" />
               </div>
               {data && data.length > 0 ? (
                data.map((item) => (
         ...
         <div className="container">
            <div className="row">
               <div className="col-lg-4 col-md-4">
                  <div className="mt-4 mb-4"><MdOutlineShoppingBag className="text-success" style={{fontSize:"48px"}}/></div>
               ...
               <div className="col-lg-4 col-md-4">
                  <div className="mt-4 mb-4"><MdOutlineRefresh className="text-success" style={{fontSize:"48px"}}/></div>
            ...
            <div className="row">
               <div className="col-lg-4 col-md-4">
                  <div className="mt-4 mb-4"><BsTruck className="text-success" style={{fontSize:"48px"}}/></div>
               ...
               <div className="col-lg-4 col-md-4">
                  <div className="mt-4 mb-4"><MdOutlineShoppingBasket className="text-success"style={{fontSize:"48px"}} /></div>
                  <h5 className="mt-3 mb-3 text-secondary">100% Satisfaction Guarantee</h5>
                  <p>There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour.</p>
               </div>
               <div className="col-lg-4 col-md-4">
                  <div className="mt-4 mb-4"><BsTag className="text-success" style={{fontSize:"48px"}}/></div>
